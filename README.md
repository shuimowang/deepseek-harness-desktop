...
- 单实例运行；重复打开会唤起现有窗口。
- 固定使用从官方标签 `dsh-v0.1.6-alpha.2` 构建并验证的 DeepSeek Harness。
...
.\scripts\Import-DshRuntime.ps1 `
  ...
  -UpstreamTag dsh-v0.1.6-alpha.2 `
  -UpstreamCommit ddefc45fbc7f8e46dd73185e68295696d1297887 `
...
当前 Harness 来源为官方标签 [`dsh-v0.1.6-alpha.2`](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.6-alpha.2)，提交 `ddefc45fbc7f8e46dd73185e68295696d1297887`。该版本仍是 Alpha，尚未完成安全审计，可能包含破坏性兼容变更；沙箱、审批和权限控制也不能保证完全隔离。本项目不修改 Harness UI 或功能实现。
